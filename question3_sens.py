...
def one_year(affordable_housing,current_homeless,built_houses,vacant_units, # MODEL INPUT VALUES
    ...
    budget = (given_budget + sum(affordable_housing[i]*pricing_increase[min(i,len(pricing_increase)-1)]*income for i in range(len(affordable_housing)))) * (1-ER_loss)
...
print()
print("No Changes")
optimal_housing(800,20,homeless_data,built_houses_data,vacant_units_data,[0]*60,[0]*60,[0]*60)
print()
# print("Natural Disaster (40% loss) after 5 years")
# optimal_housing(800,20,homeless_data,built_houses_data,vacant_units_data,[0]*5+[0.4]+[0]*50,[0]*60,[0]*60)
# print()
# print("Economic Recession (40% loss) after 5 years")
# optimal_housing(800,20,homeless_data,built_houses_data,vacant_units_data,[0]*60,[0]*5+[0.4]+[0]*50,[0]*60)
# print()
# print("Migrant Influx (30000 people) after 5 years")
# optimal_housing(800,20,homeless_data,built_houses_data,vacant_units_data,[0]*60,[0]*60,[0]*5+[30000]+[0]*50)
